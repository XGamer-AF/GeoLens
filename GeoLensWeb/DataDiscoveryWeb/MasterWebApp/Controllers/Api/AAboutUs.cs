...
namespace MasterWebApp.Controllers.Api
{
    ...
    public class AAboutUsController : ApiController
    {

        private readonly IAboutUsRepository _rep;


        public AAboutUsController(IAboutUsRepository rep)
        {
            _rep = rep;
        }
       ...
       [HttpPost]
        public async Task<IHttpActionResult> Post(AboutUs obj)
        {
            try
            {
     ...
     [HttpPut]
       public async Task<IHttpActionResult> Put(AboutUs obj)
        {
            try
            {

...
namespace MasterWebApp.Controllers.Api
{
    ...
    public class AEventRefrencesController : ApiController
    {

        private readonly IEventRefrencesRepository _rep;


        public AEventRefrencesController(IEventRefrencesRepository rep)
        {
            _rep = rep;
        }
       ...
       [HttpPost]
        public async Task<IHttpActionResult> Post(EventRefrences obj)
        {
            try
            {
     ...
     [HttpPut]
       public async Task<IHttpActionResult> Put(EventRefrences obj)
        {
            try
            {
